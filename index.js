...
emp1.leave(3);
console.log(`Monthly Salary for ${emp1.name}: $${emp1.getMonthlySalary()}`);
console.log(`Salary for 6 months: $${emp1.getSalaryForMonths(6)}`);
const bonus = emp1.calculateBonus();
console.log(`Bonus for ${emp1.name}: ${bonus}`);
